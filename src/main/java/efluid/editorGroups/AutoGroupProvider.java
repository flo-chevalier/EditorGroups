...
import efluid.editorGroups.index.MyFileNameIndexService;
...
import efluid.editorGroups.support.RegexFileResolver;
import efluid.editorGroups.support.Utils;
import efluid.editorGroups.support.VirtualFileComparator;
...
public class AutoGroupProvider {
  ...
  public static AutoGroupProvider getInstance(@NotNull Project project) {
    return project.getService(AutoGroupProvider.class);
  }
