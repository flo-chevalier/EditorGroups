...
import efluid.editorGroups.tabs2.impl.themes.KrDefaultTabTheme
...
open class KrDefaultTabPainter(private val theme: KrTabTheme = KrDefaultTabTheme()) : KrTabPainter {
  ...
  override fun paintTab(position: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition,
                        g: Graphics2D,
                        rect: Rectangle,
                        borderThickness: Int,
                        tabColor: Color?,
  ...
  override fun paintSelectedTab(position: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition,
                                g: Graphics2D,
                                rect: Rectangle,
                                borderThickness: Int,
                                tabColor: Color?,
  ...
  private fun paintLeftRightBorders(g: Graphics2D, borderThickness: Int, rect: Rectangle, position: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition) {
  ...
  override fun paintUnderline(position: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition,
                              rect: Rectangle,
                              borderThickness: Int,
                              g: Graphics2D,
                              active: Boolean) {
  ...
  protected open fun underlineRectangle(position: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition,
                                        rect: Rectangle,
