...
abstract class KrTabsRow(val infos: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>, val withTitle: Boolean, val withEntryPointToolbar: Boolean) {
