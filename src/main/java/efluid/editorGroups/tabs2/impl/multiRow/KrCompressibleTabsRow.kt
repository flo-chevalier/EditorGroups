...
import efluid.editorGroups.tabs2.KrUiDecorator
...
class KrCompressibleTabsRow(
    ...
    private fun createTabInsets(tabs: KrTabsImpl, info: KrTabInfo): TabInsets {
        val decoration = _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.mergeUiDecorations(
        ...
        val cornerToText = if (actionsPosition == _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.RIGHT) {
        ...
        val cornerToActions = when (actionsPosition) {
            _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.RIGHT -> decoration.labelInsets.right
            _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.LEFT -> decoration.labelInsets.left
            _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.NONE -> decoration.labelInsets.left + contentInsets.left
        }
        val actionsInset = when (actionsPosition) {
            _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.RIGHT -> contentInsets.right
            _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.LEFT -> contentInsets.left
            _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.NONE -> 0
        }
        return TabInsets(
    ...
    private fun createUiDecoration(tabs: KrTabsImpl, info: KrTabInfo, insets: TabInsets): KrUiDecorator.UiDecoration {
        val actionsPosition = tabs.infoToLabel.get(info)!!.actionsPosition
        val cornerToActions =
            insets.cornerToActions + if (actionsPosition == _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.NONE && insets.actionsInset > 0) insets.actionsInset else 0
        val contentInsets = Insets(
            0, if (actionsPosition == _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.LEFT) insets.actionsInset else 0,
            0, if (actionsPosition == _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.RIGHT) insets.actionsInset else 0
        )
        val originalDec = _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.mergeUiDecorations(tabs.uiDecorator!!.getDecoration(), KrTabsImpl.defaultDecorator.getDecoration())
        val labelInsets = Insets(
            originalDec.labelInsets.top,
            if (actionsPosition == _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.RIGHT) insets.cornerToText else cornerToActions,
            originalDec.labelInsets.bottom,
            if (actionsPosition == _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition.RIGHT) cornerToActions else insets.cornerToText
        )
    ...
    private class CachedDecoration(
        ...
        val actionsPosition: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel.ActionsPosition
    )
