...
import efluid.editorGroups.tabs2.*
import efluid.editorGroups.tabs2.impl.multiRow.KrMultiRowLayout
import efluid.editorGroups.tabs2.impl.multiRow.KrWrapMultiRowLayout
...
private val ABC_COMPARATOR: Comparator<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo> = Comparator { o1, o2 -> NaturalComparator.INSTANCE.compare(o1.text, o2.text) }
...
@DirtyUI
open class KrTabsImpl(private var project: Project?,
  ...
  DataProvider,
  PopupMenuListener,
    _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation,
  Queryable,
  UISettingsListener,
  QuickActionProvider,
  MorePopupAware,
  ...
  companion object {
    ...
    @JvmStatic
    fun getComponentImage(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): Image {
  ...
  private val visibleInfos = ArrayList<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>()
  private val infoToPage = HashMap<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, AccessibleTabPage>()
  private val hiddenInfos = HashMap<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, Int>()
  var mySelectedInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? = null

  val infoToLabel: MutableMap<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel> = HashMap()
  val infoToToolbar: MutableMap<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, Toolbar> = HashMap()
  ...
  private val tabListeners = ContainerUtil.createLockFreeCopyOnWriteList<_root_ide_package_.efluid.editorGroups.tabs2.KrTabsListener>()
  private var isFocused = false
  private var popupGroupSupplier: (() -> ActionGroup)? = null
  var popupPlace: String? = null
    private set
  var popupInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? = null
  ...
  private val splitter = _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabsSideSplitter(this)
  internal var effectiveLayout: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLayout? = null
  var lastLayoutPass: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrLayoutPassInfo? = null
    private set
  ...
  @JvmField
  internal val attractions: MutableSet<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo> = HashSet()
  ...
  private var allTabs: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>? = null
  ...
  var position: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition = _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.top
    private set
  ...
  var isTabDraggingEnabled: Boolean = false
    private set
  protected var dragHelper: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrDragHelper? = null
  private var navigationActionsEnabled = true
  protected var dropInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? = null

  override var dropInfoIndex: Int = 0

  override var dropSide: Int = -1
  protected var showDropLocation: Boolean = true
  private var oldSelection: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? = null
  private var mySelectionChangeHandler: _root_ide_package_.efluid.editorGroups.tabs2.KrTabs.SelectionChangeHandler? = null
  ...
  private var tabLabelAtMouse: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel? = null
  ...
  private fun isInsideTabsArea(x: Int, y: Int): Boolean {
    ...
    return when (tabsPosition) {
      _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.top -> y <= area.height
      _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.left -> x <= area.width
      _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.bottom -> y >= height - area.height
      _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.right -> x >= width - area.width
    }
  }
  ...
  private fun getScrollBarBounds(): Rectangle {
    ...
    return when (tabsPosition) {
      ...
      _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.right -> Rectangle(width - SCROLL_BAR_THICKNESS, 0, SCROLL_BAR_THICKNESS, height)
      _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.top -> Rectangle(0, 1, width, SCROLL_BAR_THICKNESS)
      _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.bottom -> Rectangle(0, height - SCROLL_BAR_THICKNESS, width, SCROLL_BAR_THICKNESS)
    }
  }
  ...
  protected open fun createDragHelper(tabs: KrTabsImpl, parentDisposable: Disposable): _root_ide_package_.efluid.editorGroups.tabs2.impl.KrDragHelper =
      _root_ide_package_.efluid.editorGroups.tabs2.impl.KrDragHelper(tabs, parentDisposable)
  ...
  protected open fun createSingleRowLayout(): _root_ide_package_.efluid.editorGroups.tabs2.impl.singleRow.KrSingleRowLayout =
      _root_ide_package_.efluid.editorGroups.tabs2.impl.singleRow.KrScrollableSingleRowLayout(this)
  ...
  fun setHovered(label: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel?) {
  ...
  fun unHover(label: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel) {
  ...
  fun isHoveredTab(label: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel?): Boolean = label != null && label === tabLabelAtMouse

  open fun isActiveTabs(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?): Boolean = UIUtil.isFocusAncestor(this)
  ...
  fun isDragOut(label: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel?, deltaX: Int, deltaY: Int): Boolean =
  ...
  fun layoutComp(data: _root_ide_package_.efluid.editorGroups.tabs2.impl.singleRow.KrSingleRowPassInfo, deltaX: Int, deltaY: Int, deltaWidth: Int, deltaHeight: Int) {
  ...
  fun isDropTarget(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): Boolean = dropInfo != null && dropInfo == info
  ...
  override fun setEmptyText(text: String?): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    emptyText = text
    return this
  }
  ...
  internal inner class TabActionsAutoHideListener : MouseMotionAdapter(), Weighted {
    private var currentOverLabel: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel? = null
  ...
  private fun showListPopup(rect: Rectangle, hiddenInfos: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>): JBPopup {
    ...
    val popup = JBPopupFactory.getInstance().createListPopup(project!!, step) {
      val descriptor = object : ListItemDescriptorAdapter<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>() {
        @Suppress("DialogTitleCapitalization")
        override fun getTextFor(value: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): String = value.text

        override fun getIconFor(value: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): Icon? = value.icon

        override fun hasSeparatorAboveOf(value: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): Boolean = value == separatorInfo
      }
      object : GroupedItemsListRenderer<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?>(descriptor) {
        private val HOVER_INDEX_KEY = Key.create<Int>("HOVER_INDEX")
        private val TAB_INFO_KEY = Key.create<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?>("TAB_INFO")
        ...
        override fun customizeComponent(list: JList<out _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?>?, info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?, isSelected: Boolean) {
          if (actionLabel != null) {
        ...
        private fun addMouseListener(list: JList<out _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>) {
  ...
  protected open fun getTabActionIcon(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, isHovered: Boolean): Icon? {
  ...
  private inner class HiddenInfosListPopupStep(values: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>, private val separatorInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?)
    : BaseListPopupStep<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>(
    null, values) {
    var selectTab = true
    override fun onChosen(selectedValue: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, finalChoice: Boolean): PopupStep<*>? {
      if (selectTab) {
    ...
    override fun getSeparatorAbove(value: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): ListSeparator? = when (value) {
    ...
    override fun getTextFor(value: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): String {
      @Suppress("DialogTitleCapitalization")
      return value.text
    }
  }

  private fun showTabLabelsPopup(rect: Rectangle, hiddenInfos: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>): JBPopup {
  ...
  override fun addTab(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, index: Int): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo =
    addTab(info = info, index = index, isDropTarget = false, fireEvents = true)

  override fun addTabSilently(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, index: Int): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo =
    addTab(info = info, index = index, isDropTarget = false, fireEvents = false)

  private fun addTab(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, index: Int, isDropTarget: Boolean, fireEvents: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo {
  ...
  protected open fun createTabLabel(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel =
      _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel(this, info)

  override fun addTab(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo = addTab(info, -1)

  override fun getTabLabel(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel = infoToLabel[info]!!

  val popupGroup: ActionGroup?
    get() = popupGroupSupplier?.invoke()

  override fun setPopupGroup(popupGroup: ActionGroup, place: String, addNavigationGroup: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabs =
    setPopupGroup({ popupGroup }, place, addNavigationGroup)

  override fun setPopupGroup(popupGroup: Supplier<out ActionGroup>,
                             place: String,
                             addNavigationGroup: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabs {
  ...
  override fun select(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, requestFocus: Boolean): ActionCallback =
    doSetSelected(info = info, requestFocus = requestFocus, requestFocusInWindow = false)

  private fun doSetSelected(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, requestFocus: Boolean, requestFocusInWindow: Boolean): ActionCallback {
    if (!isEnabled) {
  ...
  private fun executeSelectionChange(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, requestFocus: Boolean, requestFocusInWindow: Boolean): ActionCallback {
  ...
  private fun fireBeforeSelectionChanged(oldInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?, newInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?) {
    if (oldInfo != newInfo) {
  ...
  private fun fireSelectionChanged(oldInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?, newInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?) {
    if (oldInfo != newInfo) {
      for (eachListener in tabListeners) {
  ...
  private fun fireTabRemoved(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo) {
    for (eachListener in tabListeners) {
  ...
  override fun propertyChange(evt: PropertyChangeEvent) {
    val tabInfo = evt.source as _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo
    when {
      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.ACTION_GROUP == evt.propertyName -> {
        updateSideComponent(tabInfo)
        relayout(false, false)
      }

      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.COMPONENT == evt.propertyName -> {
        relayout(true, false)
      }

      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.TEXT == evt.propertyName -> {
        updateText(tabInfo)
        revalidateAndRepaint()
      }

      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.ICON == evt.propertyName -> {
        updateIcon(tabInfo)
        revalidateAndRepaint()
      }

      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.TAB_COLOR == evt.propertyName -> {
        revalidateAndRepaint()
      }

      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.ALERT_STATUS == evt.propertyName -> {
        val start = evt.newValue as Boolean
        updateAttraction(tabInfo, start)
      }

      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.TAB_ACTION_GROUP == evt.propertyName -> {
        updateTabActions(tabInfo)
        relayout(false, false)
      }

      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.HIDDEN == evt.propertyName -> {
        updateHiding()
        relayout(false, false)
      }

      _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.ENABLED == evt.propertyName -> {
        updateEnabling()
      }
    }
  }
  ...
  private fun getIndexInVisibleArray(each: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): Int {
  ...
  private fun updateIcon(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo) {
  ...
  private fun updateAttraction(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, start: Boolean) {
    if (start) {
  ...
  private fun updateText(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo) {
    val label = infoToLabel[tabInfo]
    label!!.setText(tabInfo.coloredText)
    label.toolTipText = tabInfo.tooltipText
  }

  private fun updateSideComponent(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo) {
  ...
  private fun updateTabActions(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo) {
    infoToLabel[info]!!.setTabActions(info.tabLabelActions)
  }

  override fun getSelectedInfo(): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? {
    return when {
      oldSelection != null -> {
        oldSelection
      }
  ...
  public fun setSelectedInfo(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?) {
    mySelectedInfo = info
  ...
  override fun getToSelectOnRemoveOf(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? {
    if (!visibleInfos.contains(info) || mySelectedInfo != info || visibleInfos.size == 1) {
      return null
    }

    val index = getVisibleInfos().indexOf(info)
    var result: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? = null
    if (index > 0) {
  ...
  fun findEnabledForward(from: Int, cycle: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? {
    if (from < 0) {
      return null
    }
  ...
  fun findEnabledBackward(from: Int, cycle: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? {
    if (from < 0) {
      return null
    }
  ...
  private fun createToolbarComponent(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): Toolbar = Toolbar(tabs = this, info = tabInfo)

  override fun getTabAt(tabIndex: Int): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo = tabs[tabIndex]

  @RequiresEdt
  override fun getTabs(): List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo> {
    allTabs?.let {
      return it
    }
  ...
  override fun getTargetInfo(): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? = popupInfo ?: selectedInfo
  ...
  override fun setToDrawBorderIfTabsHidden(toDrawBorderIfTabsHidden: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation = this

  override fun getJBTabs(): _root_ide_package_.efluid.editorGroups.tabs2.KrTabs = this

  class Toolbar(private val tabs: KrTabsImpl, private val info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo) : JPanel(BorderLayout()) {
    init {
      isOpaque = false
  ...
  override fun doLayout() {
    try {
      ...
      if (effectiveLayout is _root_ide_package_.efluid.editorGroups.tabs2.impl.singleRow.KrSingleRowLayout) {
        ...
        if (divider.parent === this) {
          val location = if (tabsPosition == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.left) {
  ...
  protected open val draggedTabSelectionInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?
    get() = selectedInfo

  private fun computeHeaderFitSize(): Dimension {
    val max = computeMaxSize()
    return if (position == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.top || position == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.bottom) {
  ...
  override fun setInnerInsets(innerInsets: Insets): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
  ...
  private fun reset(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, resetLabels: Boolean) {
  ...
  val selectedLabel: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel?
    get() = infoToLabel[selectedInfo]

  open fun getVisibleInfos(): List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo> {
  ...
  private fun groupPinnedFirst(infos: MutableList<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>) {
  ...
  private fun addHeaderSize(size: Dimension, tabsCount: Int) {
    ...
    val horizontal = tabsPosition == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.top || tabsPosition == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.bottom
    if (horizontal) {
  ...
  private fun computeHeaderPreferredSize(tabsCount: Int): Dimension {
    val infos: Iterator<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?> = infoToLabel.keys.iterator()
    val size = Dimension()
    var currentTab = 0
    val horizontal = tabsPosition == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.top || tabsPosition == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.bottom
    while (infos.hasNext()) {
  ...
  override fun getPresentation(): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation = this

  override fun removeTab(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?): ActionCallback = doRemoveTab(info, null, false)

  override fun removeTab(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, forcedSelectionTransfer: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?) {
    doRemoveTab(info, forcedSelectionTransfer, false)
  }

  @RequiresEdt
  private fun doRemoveTab(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?, forcedSelectionTransfer: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?, isDropTarget: Boolean): ActionCallback {
    if (removeNotifyInProgress) {
      LOG.warn(IllegalStateException("removeNotify in progress"))
    }
  ...
  private fun isFocused(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo): Boolean {
    val label = infoToLabel[info]
  ...
  private fun processRemove(info: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?, forcedNow: Boolean) {
  ...
  override fun findInfo(component: Component): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? {
    for (each in tabs) {
  ...
  override fun findInfo(event: MouseEvent): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? {
    val point = SwingUtilities.convertPoint(event.component, event.point, this)
    return doFindInfo(point, false)
  }

  override fun findInfo(`object`: Any): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? {
  ...
  private fun doFindInfo(point: Point, labelsOnly: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo? {
  ...
  private fun updateEntryPointToolbar() {
    ...
    val group = if (tabActionGroup != null && entryPointActionGroup != null) {
      ...
      if (!moreToolbar!!.component.bounds.isEmpty &&
        ...
        (!_root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLayout.showPinnedTabsSeparately() || tabs.all { !it.isPinned })) {
  ...
  override fun addTabMouseListener(listener: MouseListener): _root_ide_package_.efluid.editorGroups.tabs2.KrTabs {
    removeListeners()
  ...
  override fun addListener(listener: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsListener): _root_ide_package_.efluid.editorGroups.tabs2.KrTabs = addListener(listener = listener, disposable = null)

  override fun addListener(listener: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsListener, disposable: Disposable?): _root_ide_package_.efluid.editorGroups.tabs2.KrTabs {
  ...
  override fun setSelectionChangeHandler(handler: _root_ide_package_.efluid.editorGroups.tabs2.KrTabs.SelectionChangeHandler): _root_ide_package_.efluid.editorGroups.tabs2.KrTabs {
  ...
  override fun getIndexOf(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?): Int = getVisibleInfos().indexOf(tabInfo)
  ...
  override fun setActiveTabFillIn(color: Color?): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
  ...
  override fun setTabLabelActionsAutoHide(autoHide: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
  ...
  override fun setFocusCycle(root: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    isFocusCycleRoot = root
    return this
  }

  override fun setPaintFocus(paintFocus: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
  ...
  private abstract class BaseNavigationAction(copyFromId: @NlsSafe String,
    ...
    override fun actionPerformed(e: AnActionEvent) {
      ...
      var infos: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?>
      var index: Int
      while (true) {
    ...
    protected abstract fun borderIndex(infos: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?>, index: Int): Boolean

    protected abstract fun doActionPerformed(e: AnActionEvent?, tabs: KrTabsImpl?, selectedIndex: Int)
  }

  private class SelectNextAction(tabs: KrTabsImpl, parentDisposable: Disposable) : BaseNavigationAction(IdeActions.ACTION_NEXT_TAB, tabs,
    parentDisposable) {
    ...
    override fun borderIndex(infos: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?>, index: Int): Boolean = index == infos.size - 1
  ...
  private class SelectPreviousAction(tabs: KrTabsImpl, parentDisposable: Disposable) : BaseNavigationAction(IdeActions.ACTION_PREVIOUS_TAB,
    ...
    override fun borderIndex(infos: List<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?>, index: Int): Boolean = index == 0
  ...
  override fun setSideComponentVertical(vertical: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    horizontalSide = !vertical
    for (each in visibleInfos) {
      each.changeSupport.firePropertyChange(_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo.ACTION_GROUP, "new1", "new2")
    }
    relayout(true, false)
    return this
  }

  override fun setSideComponentOnTabs(onTabs: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    isSideComponentOnTabs = onTabs
    relayout(true, false)
    return this
  }

  override fun setSideComponentBefore(before: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    isSideComponentBefore = before
    relayout(true, false)
    return this
  }

  override fun setSingleRow(singleRow: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    this.singleRow = singleRow
    updateRowLayout()
    return this
  }

  private fun setLayout(layout: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLayout): Boolean {
  ...
  override fun setUiDecorator(decorator: KrUiDecorator?): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
  ...
  protected open fun adjust(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo) {
    if (ADJUST_BORDERS) {
      @Suppress("DEPRECATION")
  ...
  override fun sortTabs(comparator: Comparator<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>) {
    visibleInfos.sortWith(comparator)
    resetTabsCache()
    relayout(forced = true, layoutNow = false)
  }

  protected fun reorderTab(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, newIndex: Int) {
  ...
  override fun setRequestFocusOnLastFocusedComponent(requestFocusOnLastFocusedComponent: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
  ...
  private class DefaultDecorator : KrUiDecorator {
    override fun getDecoration(): KrUiDecorator.UiDecoration {
      return KrUiDecorator.UiDecoration(labelFont = null,
  ...
  override fun setTabLabelActionsMouseDeadzone(length: TimedDeadzone.Length): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
  ...
  override fun setTabsPosition(position: _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
  ...
  override fun getTabsPosition(): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition = position

  override fun setTabDraggingEnabled(enabled: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    isTabDraggingEnabled = enabled
    return this
  }

  override fun setAlphabeticalMode(value: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    alphabeticalMode = value
    return this
  }

  override fun setSupportsCompression(value: Boolean): _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPresentation {
    supportCompression = value
    updateRowLayout()
    return this
  }

  fun reallocate(source: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?, target: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?) {
  ...
  val isHorizontalTabs: Boolean
    get() = tabsPosition == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.top || tabsPosition == _root_ide_package_.efluid.editorGroups.tabs2.KrTabsPosition.bottom

  override fun putInfo(info: MutableMap<in String, in String>) {
    selectedInfo?.putInfo(info)
  }

  override fun resetDropOver(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo) {
    if (dropInfo != null) {
  ...
  override fun startDropOver(tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, point: RelativePoint): Image {
    dropInfo = tabInfo
  ...
  override fun processDropOver(over: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo, point: RelativePoint) {
    val pointInMySpace = point.getPoint(this)
    val index = effectiveLayout!!.getDropIndexFor(pointInMySpace)
  ...
  protected inner class AccessibleJBTabsImpl internal constructor() : AccessibleJComponent(), AccessibleSelection {
    init {
      accessibleComponent
      addListener(object : _root_ide_package_.efluid.editorGroups.tabs2.KrTabsListener {
        override fun selectionChanged(oldSelection: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?, newSelection: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo?) {
    ...
    override fun getAccessibleChild(i: Int): Accessible? {
      ...
      return if (accessibleChild is _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel) infoToPage[accessibleChild.info] else accessibleChild
    }
...
private fun sortTabsAlphabetically(tabs: MutableList<_root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo>) {
 ...
 */
private class AccessibleTabPage(private val parent: KrTabsImpl,
                                private val tabInfo: _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo
  ...
  private val tabLabel: _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel?
...
private class TitleAction(private val tabs: KrTabsImpl,
  ...
  private val label = object : JLabel() {
    ...
    override fun updateUI() {
      super.updateUI()
      font = _root_ide_package_.efluid.editorGroups.tabs2.impl.KrTabLabel(tabs, _root_ide_package_.efluid.editorGroups.tabs2.KrTabInfo(null)).labelComponent.font
