package efluid.editorGroups.tabs2.my;
...
import efluid.editorGroups.SwitchRequest;
import efluid.editorGroups.tabs2.KrTabInfo;
import efluid.editorGroups.tabs2.KrTabPainter;
import efluid.editorGroups.tabs2.impl.KrEditorTabs;
import efluid.editorGroups.tabs2.impl.KrTabLabel;
import efluid.editorGroups.tabs2.impl.singleRow.KrScrollableSingleRowLayout;
import efluid.editorGroups.tabs2.impl.singleRow.KrSingleRowLayout;
...
public class MyJBEditorTabs extends KrEditorTabs {
   ...
   * at efluid.editorGroups.tabs2.impl.JBTabsImpl$7.initialize(JBTabsImpl.java:340)
   * at efluid.editorGroups.tabs2.impl.JBTabsImpl$7.initialize(JBTabsImpl.java:333)
   */
