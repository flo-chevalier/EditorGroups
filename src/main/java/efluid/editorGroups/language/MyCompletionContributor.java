package efluid.editorGroups.language;
...
import efluid.editorGroups.language.annotator.LanguagePatternHolder;
  ...
  public MyCompletionContributor() {
    extend(CompletionType.BASIC, PlatformPatterns.psiElement(), new CompletionProvider<CompletionParameters>() {
      ...
      protected void addCompletions(@NotNull CompletionParameters parameters, ProcessingContext context, @NotNull CompletionResultSet result) {
        ...
        TextCompletionProvider provider = new MyCompletionProvider(new MyStringValueDescriptor(), values, List.of(' '));
